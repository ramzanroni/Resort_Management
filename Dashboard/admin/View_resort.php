        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 style="margin-bottom: 30px;" class="mt-4">View Resort</h1>
                                 ...
                                 <tbody>
                                    ...
                                    while($row=mysqli_fetch_assoc($result)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                               <img style="width: 100px; height: 80px" src="images/<?php echo $row['image']; ?>">
                                           </td>
                                           <td style="text-align: center"><a class="btn btn-danger m-2" href=" View_resort.php?delete_id=<?php echo $row['id']; ?>"><i class="fas fa-trash"></i></a>
                                            <a href="edit_resort.php?edit=<?php echo $row['id']; ?>" class="btn btn-info m-2"><i  class="fas fa-edit"></i></a></td>
                                           </tr>
                                           <?php
                                       }
