        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 style="margin-bottom: 30px;" class="mt-4">ADD A NEW RESORT</h1>
                    ...
                    $sql=$con->query("INSERT INTO `add_resort`(`resort_name`, `troom`, `bed`, `number_room`, `price`, `description`, `status`, `image`) VALUES ('$resort_name', '$troom','$bed','$number_room','$price','$description','$status','$userpic')");
               ...
               //
                ...
                <form style="font-size: 20px;" method="post" enctype="multipart/form-data">
                  ...
                  <div>
                      <input type="submit" name="submit" value="Add Resort" class="btn" style="background-color:orange;color: white; padding: 5px">
                  </div>
              </form>
          </div>
