...
$sql="SELECT * FROM `tbl_booking` WHERE `status`='check_in'";
...
{
    $id_up=$_GET['check_out'];
    $sql_up=$con->query("UPDATE `tbl_booking` SET `status`='check_out' WHERE id='$id_up'");
    if ($sql_up) 
    {
        echo "<script>
                    alert('Check Out Successfully.. !');
                    document.location = 'view_booking.php';
                </script>";
    }
    else
    {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 style="margin-bottom: 30px" class="mt-4">Check In Customer</h1>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <td><a class="btn btn-info m-2 float-left" href="view_booking.php?check_out=<?php echo $row['id']; ?>">Check Out</a></td>
